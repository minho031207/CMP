# =============================================================================
# bcat_retention_r7_ivsn_integral_off.cmd
# CMP Run 7 — leakage-versus-storage-node-voltage BTBT-OFF attribution reference
#
# Same geometry/circuit/bias as the ON branch; NonlocalPath is intentionally removed.
# This is a project background diagnostic, not a complete physical leakage decomposition.
# =============================================================================
